...
class DonationUser(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.is_active == True:
            send_mail('subject', f'This is you membership id {self.membership_id}', 'donate@gmail.com', [self.email,])
        else:
            send_mail('subject', f'Your form on review', 'donate@gmail.com', [self.email,])
        super(DonationUser, self).save(*args, **kwargs)
...
class Message(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        for subscriber in subscribers:
            send_mail(self.subject, self.content, 'donate@gmail.com', [subscriber.mail])
